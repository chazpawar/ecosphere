      ...
      <div className="w-full max-w-md overflow-hidden rounded-2xl flex flex-col gap-12">
        ...
        <AuthForm action={handleSubmit} defaultEmail={email}>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
          >
